...
try:
    ...
    ACTIVITY_ITEMS = [
        ...
        {"name": "活動4",  "x": 587, "y": 1010},
        {"name": "活動5",  "x": 587, "y": 1010},
        {"name": "活動6",  "x": 587, "y": 1010},
        {"name": "活動7",  "x": 587, "y": 1010},
        {"name": "活動8",  "x": 587, "y": 1010},
        {"name": "活動9",  "x": 587, "y": 1010},
        {"name": "活動10", "x": 587, "y": 1010},
        {"name": "活動11", "x": 587, "y": 1125},
        {"name": "活動12", "x": 587, "y": 1315},
    ]
    REPEAT_TAP_X = 587
    REPEAT_TAP_Y = 1315
    ...
    for tab_index, tab in enumerate(tabs):
        ...
        # 頁籤1 用 70%，其餘用 90%
        SIMILARITY_THRESHOLD = 70.0 if tab_index == 0 else 90.0
        ...
        for item_index, item in enumerate(ACTIVITY_ITEMS):
            ...
            if previous_path is not None:
                ...
                if similarity > SIMILARITY_THRESHOLD:
                    print(f"    畫面相同（>{SIMILARITY_THRESHOLD}%），刪除並切換下一頁籤")
                    try:
